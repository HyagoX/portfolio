  ...
  head: () => ({
    meta: [
      ...
      { title: "Hyago — Landing Pages de Alta Conversão" },
      {
        name: "description",
        content:
          "Portfólio de Hyago: especialista em desenvolvimento de landing pages simples, rápidas e de alta conversão.",
      },
      { name: "author", content: "Hyago" },
      {
        property: "og:title",
        content: "Hyago — Landing Pages de Alta Conversão",
      },
      {
